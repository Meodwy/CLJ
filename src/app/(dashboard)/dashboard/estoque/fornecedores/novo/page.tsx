  ...
  return (
    <div className="mx-auto max-w-lg space-y-6">
      <div className="flex items-center gap-4">
        ...
        <div>
          <h1 className="font-heading text-xl font-medium text-foreground">Novo Fornecedor</h1>
          <p className="text-sm text-muted-foreground">Cadastre um novo fornecedor no sistema</p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <Input id="razao_social" name="razao_social" placeholder="Razão social do fornecedor"
                disabled={loading} aria-invalid={!!errors.razao_social} className={inputClass} />
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="nome_fantasia" name="nome_fantasia" placeholder="Nome fantasia" disabled={loading} className={inputClass} />
              </div>

              {/* CNPJ */}
              <div className="space-y-1.5">
                <Label htmlFor="cnpj" className="text-[13px] font-medium text-foreground/80">CNPJ</Label>
                <Input id="cnpj" name="cnpj" placeholder="00.000.000/0000-00" disabled={loading}
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-1.5">
                ...
                <Input id="telefone" name="telefone" placeholder="(11) 99999-9999" disabled={loading} className={inputClass} />
              </div>

              {/* Email */}
              <div className="space-y-1.5">
                <Label htmlFor="email" className="text-[13px] font-medium text-foreground/80">Email</Label>
                <Input id="email" name="email" type="email" placeholder="fornecedor@email.com" disabled={loading}
            ...
            <div className="space-y-1.5">
              ...
              <Input id="endereco" name="endereco" placeholder="Endereço completo" disabled={loading} className={inputClass} />
            </div>

            {/* Contato */}
            <div className="space-y-1.5">
              <Label htmlFor="contato" className="text-[13px] font-medium text-foreground/80">Contato</Label>
              <Input id="contato" name="contato" placeholder="Nome do contato" disabled={loading} className={inputClass} />
            </div>
            ...
            <div className="flex items-center gap-3 pt-2">
              <Button type="submit"
                ...
                {loading ? (
                  ...
                  <><Building2 className="mr-2 h-[18px] w-[18px]" />Cadastrar</>
                )}
              </Button>
