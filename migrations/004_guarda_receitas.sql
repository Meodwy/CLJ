-- ============================================================
-- CLJ Clínica — Módulo Guarda de Receitas (v1)
-- Migration 004
-- ============================================================
...
-- Pharmacist can only update specific statuses
...
-- AUDIT LOGS RLS (append-only: only SELECT + INSERT)
...
BEGIN
  INSERT INTO prescription_audit_logs (
    ...
    p_previous_status, p_new_status, p_metadata,
    inet_client_addr()
  )
...
-- Storage RLS: only authenticated users with proper role
