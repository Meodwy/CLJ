...
async function api(method, table, body, retries = 3) {
...
async function main() {
  console.log('=== Seed Compounding Orders (com retry) ===\n')
  ...
  const orders = [
    ...
    { status: 'CANCELLED', form: 'Gel', qty: 80, unit: 'g', priority: 'LOW', prevStatus: 'AWAITING_PHARMACEUTICAL_REVIEW', hoursAgo: -144, cancelReason: 'Paciente desistiu' },
  ]
